...
export default function FaqQuestions() {
    return (
        <div
            id="faq"
            className="flex flex-col items-end justify-end w-full gap-y-16 pt-[calc(var(--header)+1rem)] -mt-[calc(var(--header)+1rem)]"
        >
            <Heading
                title="PERGUNTAS FREQUENTES"
                className="text-end items-end justify-end"
            >
                Buscamos ser um exemplo em transparência para que nosso contato
                com você se mantenha o mais leal possível. <br /> Por isso, nos
                comprometemos em manter todas as dúvidas sanadas :)
            </Heading>
            <ul className="flex flex-col items-center justify-center w-full gap-y-6">
                ...
                <Question
                    key={2}
                    question={[
                        `Por que o período de testes do plano Plus só dura 7 dias?`
                    ]}
